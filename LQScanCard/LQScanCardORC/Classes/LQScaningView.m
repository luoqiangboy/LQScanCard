...
- (void)creatUI
{
    ...
    UIImage *img = [UIImage imageNamed:@"scaningline" inBundle:[LQCardRectTool getImageBundle] compatibleWithTraitCollection:nil];
...
- (UIImageView *)bgImageView
{
    if (_bgImageView == nil)
    {
        ...
        UIImage *imag = [UIImage imageNamed:@"scaningbgimage" inBundle:[LQCardRectTool getImageBundle] compatibleWithTraitCollection:nil];
...
- (UIImageView *)scanImageView
{
    if (_scanImageView == nil)
    {
        ...
        UIImage *imag = [UIImage imageNamed:@"scaningline" inBundle:[LQCardRectTool getImageBundle] compatibleWithTraitCollection:nil];
...
- (UIButton *)turnOnOrOffBtn
{
    if (_turnOnOrOffBtn == nil)
    {
        ...
        UIImage *imag = [UIImage imageNamed:@"flashlightscan" inBundle:[LQCardRectTool getImageBundle] compatibleWithTraitCollection:nil];
...
- (void)setScanType:(LQScaningType)scanType
{
    _scanType = scanType;
    if (scanType == LQScaningTypeIDCard)
    {
        self.scanLab.text = @"扫描身份证";
    }
    else if (scanType == LQScaningTypeBank)
    {
